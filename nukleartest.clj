...
(while (not (GLFW/glfwWindowShouldClose window))
       ...
       (when (Nuklear/nk_begin context "Nuklear Example" (Nuklear/nk_rect 0 0 width height rect) 0)
         ...
         (Nuklear/nk_style_push_vec2 context (.group_padding (.window (.style context))) no-padding)
         (Nuklear/nk_group_begin context "buttons-1" Nuklear/NK_WINDOW_NO_SCROLLBAR)
         ...
         (Nuklear/nk_group_end context)
         (Nuklear/nk_group_begin context "buttons-2" Nuklear/NK_WINDOW_NO_SCROLLBAR)
