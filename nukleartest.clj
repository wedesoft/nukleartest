...
(def quality (.put (BufferUtils/createDoubleBuffer 1) 0 (double 5.0)))
...
(while (not (GLFW/glfwWindowShouldClose window))
       ...
       (when (Nuklear/nk_begin ^NkContext context "Nuklear Example" (Nuklear/nk_rect 0 0 width height rect) Nuklear/NK_WINDOW_NO_SCROLLBAR)
         ...
         (Nuklear/nk_property_double ^NkContext context "Quality:" 0.0 ^java.nio.DirectDoubleBufferU quality 10.0 1.0 0.01)
